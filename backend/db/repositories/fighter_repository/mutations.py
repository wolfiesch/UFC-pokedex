"""Mutation helpers for fighter data."""
...
class FighterMutationMixin:
    """Mixin bundling mutation operations for fighters."""
    ...
    async def update_fighter_nationality(
        self, fighter_id: str, nationality: str
    ) -> None:
    ...
    async def get_fighters_without_ufc_com_data(self) -> list[Fighter]:
