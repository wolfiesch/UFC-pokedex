"""Mutation helpers for fighter repository implementations."""
...
class FighterMutationMixin(BaseRepository):
    """Provide create/update routines for fighter persistence."""
