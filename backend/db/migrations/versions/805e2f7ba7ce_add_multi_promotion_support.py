...
def upgrade() -> None:
    ...
    op.drop_index('ix_fighters_name_trgm', table_name='fighters', postgresql_using='gin', if_exists=True)
    op.drop_index('ix_fighters_nickname_trgm', table_name='fighters', postgresql_using='gin', if_exists=True)
