...
def upgrade() -> None:
    ...
    op.drop_index("idx_historical_rankings_date", table_name="historical_rankings", if_exists=True)
    op.drop_index(
        "idx_historical_rankings_division", table_name="historical_rankings", if_exists=True
    )
    op.drop_index(
        "idx_historical_rankings_fighter", table_name="historical_rankings", if_exists=True
    )
    ...
    op.create_unique_constraint(
        ...
        "fighter_rankings",
        ["fighter_id", "division", "rank_date", "source"],
    )
    ...
    op.drop_index("ix_fighters_birthplace_country_division", table_name="fighters", if_exists=True)
    op.drop_index(
        "ix_fighters_name_trgm", table_name="fighters", postgresql_using="gin", if_exists=True
    )
    op.drop_index(
        "ix_fighters_nickname_trgm", table_name="fighters", postgresql_using="gin", if_exists=True
    )
    op.drop_index("ix_fighters_streak_composite", table_name="fighters", if_exists=True)
    op.drop_index("ix_fighters_training_country_division", table_name="fighters", if_exists=True)
    op.create_index(
        op.f("ix_fighters_primary_promotion"), "fighters", ["primary_promotion"], unique=False
    )
    ...
    op.add_column(
        "fights", sa.Column("is_amateur", sa.Boolean(), nullable=False, server_default="false")
    )
    ...
    op.drop_index("ix_fights_fighter_id_event_date", table_name="fights", if_exists=True)
    op.drop_index("ix_fights_opponent_event_date", table_name="fights", if_exists=True)
    op.drop_index("ix_fights_opponent_id_event_date", table_name="fights", if_exists=True)
    op.create_index(
        op.f("ix_fights_event_sherdog_id"), "fights", ["event_sherdog_id"], unique=False
    )
    op.create_index(
        op.f("ix_fights_opponent_sherdog_id"), "fights", ["opponent_sherdog_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.create_index(
        "ix_fighters_nickname_trgm", "fighters", ["nickname"], unique=False, postgresql_using="gin"
    )
    op.create_index(
        "ix_fighters_name_trgm", "fighters", ["name"], unique=False, postgresql_using="gin"
    )
    op.create_index(
    ...
    op.create_index(
        "idx_historical_rankings_issue", "historical_rankings", ["issue_number"], unique=False
    )
    op.create_index(
        "idx_historical_rankings_fighter", "historical_rankings", ["fighter_name"], unique=False
    )
    op.create_index(
        "idx_historical_rankings_division", "historical_rankings", ["division_code"], unique=False
    )
    op.create_index(
        "idx_historical_rankings_date",
        "historical_rankings",
