...
export function useSearch() {
  ...
  const nationalityFilter = useFavoritesFiltersStore((state) => state.nationalityFilter);
  ...
  const setNationalityFilter = useFavoritesFiltersStore((state) => state.setNationalityFilter);
