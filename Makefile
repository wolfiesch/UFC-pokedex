...
dev: dev-tunnel ## Default: Start with Cloudflare tunnel (alias for dev-tunnel)

dev-tunnel: ensure-docker ## Start backend + frontend with ngrok tunnel (public HTTPS access)
	@echo ""
	...
	echo "   • ngrok provides stable HTTPS tunnel with proper SSL"; \
