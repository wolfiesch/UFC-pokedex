...
dev-tunnel: ensure-docker ## Start backend + frontend with Cloudflare tunnel (public HTTPS access)
	...
	echo ""; \
	echo "💡 How it works:"; \
	echo "   • Frontend uses Next.js proxy (/api) to avoid SSL issues"; \
	echo "   • Cloudflare tunnel doesn't support second-level subdomains"; \
