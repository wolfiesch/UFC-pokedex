...
- ❌ Easy to forget
- ❌ Doesn't match "no env changes" claim
...
dev-local: ensure-docker ## Start backend + frontend with localhost URLs (no tunnels, no env changes)
	...
	@sleep 1
	@echo ""
	@echo "⚙️  Configuring localhost URLs..."
	@mkdir -p frontend
	...
	@echo "✅ Configured frontend to use http://localhost:8000"
...
- ✅ Console shows requests to `http://localhost:8000`
- ✅ No CORS errors
...
**Expected:**
- ✅ `.env.local` overwritten with localhost URLs
...
**Expected:**
- ✅ `.env.local` always correct after `make dev-local`
...
3. Test each page:
   - Home page: ✅ Loads fighters
   - Search: ✅ Returns results
   - Fighter detail: ✅ Shows data
   - Events: ✅ Lists events
   - Favorites: ✅ Can add/remove (if implemented)
...
- ✅ Running `make dev-local` from any state results in working localhost setup
- ✅ Search functionality returns results
- ✅ Fighter detail pages load data
- ✅ Events page shows events
- ✅ No CORS errors in console
- ✅ No `ERR_FAILED` network errors
- ✅ Documentation matches actual behavior
- ✅ All automated tests pass (if they exist)
